...
import { _ as _sfc_main$1, a as _sfc_main$2, b as _sfc_main$3, c as _sfc_main$4 } from "./DeleteHighAreaDialog-CmmgKHsn.js";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const currentFloor = ref({
      name: ((_h = (_g = myFloors.value.filter(
        (floor) => floor["block_id"] == currentBlock.value.value
      )) == null ? void 0 : _g[0]) == null ? void 0 : _h.name) ?? "",
      value: ((_j = (_i = myFloors.value.filter(
        (floor) => floor["block_id"] == currentBlock.value.value
    ...
    const handleDropdown = (event, type) => {
      ...
      if (type == "zone") {
        ...
        currentFloor.value = {
          name: ((_f2 = (_e2 = myFloors.value.filter(
            (floor) => floor["block_id"] == currentBlock.value.value
          )) == null ? void 0 : _e2[0]) == null ? void 0 : _f2.name) ?? "",
          value: `${(_h2 = (_g2 = myFloors.value.filter(
            (floor) => floor["block_id"] == currentBlock.value.value
          )) == null ? void 0 : _g2[0]) == null ? void 0 : _h2.value}` ?? ""
        };
      }
      if (type == "block") {
        myFloors.value = floors.value.filter(
        ...
        currentFloor.value = {
          name: ((_j2 = (_i2 = myFloors.value.filter(
            (floor) => floor["block_id"] == currentBlock.value.value
          )) == null ? void 0 : _i2[0]) == null ? void 0 : _j2.name) ?? "",
          value: ((_l = (_k = myFloors.value.filter(
            (floor) => floor["block_id"] == currentBlock.value.value
          )) == null ? void 0 : _k[0]) == null ? void 0 : _l.value) ?? ""
        };
      }
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ViewDetailsHighAreaDialog = _sfc_main$1;
      const _component_CreateHighAreaDialog = _sfc_main$2;
      const _component_EditHighAreaDialog = _sfc_main$3;
...
//# sourceMappingURL=index-BUWO9AXk.js.map
