...
import script$4 from "./calendar.esm-iTjSyI1e.js";
import script$5 from "./inputswitch.esm-QEGDpbo-.js";
...
import { g as getYearMonthDay, a as convertDateTime } from "./core_utils-WJ_cJnbk.js";
  ...
  setup(__props) {
    ...
    const currentZone = ref({
      ...
      value: ((_d = (_c = zones.value.filter(
        (zone2) => zone2["id"] == currentBlock.value["zone_id"]
      )) == null ? void 0 : _c[0]) == null ? void 0 : _d["value"]) ?? ((_f = (_e = zones.value.filter(
        (zone2) => zone2["id"] == currentBlock.value["zone_id"]
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const desc = ref("");
    const type = ref({
      name: ((_d = (_c = types.value) == null ? void 0 : _c[0]) == null ? void 0 : _d.name) ?? "",
      value: ((_f = (_e = types.value) == null ? void 0 : _e[0]) == null ? void 0 : _f.value) ?? ""
    });
...
//# sourceMappingURL=DeleteBlockDialog-CTF5zDEs.js.map
