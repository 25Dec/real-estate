import script$4 from "./tag.esm-Bkya-FxV.js";
import script$5 from "./iconfield.esm-CMjnwUAR.js";
import script$6 from "./inputicon.esm-DsrGfACI.js";
...
import script$2 from "./dropdown.esm-BZz-eegH.js";
import script$7 from "./datatable.esm-BAh19VmC.js";
import script$8 from "./column.esm-KktM_xTo.js";
import script$9 from "./avatar.esm-G-uX_ALX.js";
import { _ as _sfc_main$3, a as _sfc_main$4 } from "./EditCustomerDialog-BDEjiSHU.js";
import script from "./dialog.esm-Wemb0g_v.js";
import { u as useCustomersStore } from "./customers-store-DoxVOnyQ.js";
import { withAsyncContext, ref, mergeProps, unref, isRef, withCtx, createVNode, useSSRContext, createTextVNode, toDisplayString, computed, resolveDirective } from "vue";
import "hookable";
import "destr";
import "klona";
import "devalue";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconField = script$5;
      const _component_InputIcon = script$6;
      const _component_Icon = __nuxt_component_1;
      const _component_InputText = script$1;
      const _component_Button = script$3;
      const _component_Dropdown = script$2;
      const _component_DataTable = script$7;
      const _component_Column = script$8;
      const _component_Avatar = script$9;
      const _component_ViewDetailsCustomerDialog = _sfc_main$3;
      const _component_CreateCustomerDialog = _sfc_main$2;
      const _component_EditCustomerDialog = _sfc_main$4;
              ...
              body: withCtx(({ data }, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_Avatar, {
                    label: (_a2 = data["first_name"]) == null ? void 0 : _a2.substring(0, 3),
                    shape: "square"
                  ...
                  return [
                    createVNode("div", { class: "flex items-center gap-3" }, [
                      createVNode(_component_Avatar, {
                        label: (_b2 = data["first_name"]) == null ? void 0 : _b2.substring(0, 3),
                        shape: "square"
                      }, null, 8, ["label"]),
...
//# sourceMappingURL=index-CkxwJyjB.js.map
