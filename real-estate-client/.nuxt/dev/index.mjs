...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/devalue/index.js';
import destr from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/vue/index.mjs';
import { version, unref } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/pathe/dist/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/Code_Files/real-estate/real-estate-client/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "D:/Code_Files/real-estate/real-estate-client/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"D:/Code_Files/real-estate/real-estate-client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Code_Files\\real-estate\\real-estate-client","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\Code_Files\\real-estate\\real-estate-client\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Code_Files\\real-estate\\real-estate-client\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\Code_Files\\real-estate\\real-estate-client\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\Code_Files\\real-estate\\real-estate-client\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "D:/Code_Files/real-estate/real-estate-client";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _i48bXnWS2w = (nitroApp) => {
...
const _kLkK3LmlD8 = defineNitroPlugin(async (nitroApp) => {
...
const _l7SVRs = lazyEventHandler(() => {
...
const _lazy_fOiOsb = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_fOiOsb, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _l7SVRs, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fOiOsb, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/Code_Files/real-estate/real-estate-client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/Code_Files/real-estate/real-estate-client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
