  ...
  <div class="w-full h-full flex flex-col">
    ...
    <div class="absolute top-[16%] w-full h-[92%]">
      ...
      >
        ...
        <Column field="type" header="Buy Status">
          <template #body="{ data }">
            {{ data["buy_status"] }}
          </template>
        </Column>
        ...
        <Column header="Actions">
          <template #body="{ data }">
            ...
            <Button text severity="secondary" @click="toggleEditLandArea(data)">
              <Icon name="mdi:edit-outline" />
            </Button>
            <Button text severity="danger" @click="toggleDeleteLandArea(data)">
