  ...
  <div class="w-full h-full flex flex-col">
    ...
    <div class="absolute top-[16%] w-full h-[92%]">
      ...
      >
        ...
        <Column field="total_area" header="Total Area" :sortable="true">
          <template #body="{ data }">
            {{ data["total_area"] }}
          </template>
        </Column>
        ...
        <Column header="Actions">
          <template #body="{ data }">
            ...
            <Button text severity="secondary" @click="toggleEditFloor(data)">
              <Icon name="mdi:edit-outline" />
            </Button>
            <Button text severity="danger" @click="toggleDeleteFloor(data)">
